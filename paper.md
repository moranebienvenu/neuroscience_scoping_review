# Chapter 3 — Scoping Review: Reproducibility Practices in Neuroscience (2015–2025)
...
## 3.7 Selection of Sources of Evidence
...
To ensure reliability, the automated detection rules were validated on a manually reviewed sample of 25 articles using the RRInsights custom GPT [@Karakuzu2024] tool prior to full deployment. Each article was then categorized into one of four mutually exclusive sharing categories, as shown in Table 3.1.
...
## 3.10 Critical Appraisal of Individual Sources of Evidence
...
### 3.11.1 Text Embedding: SPECTER2
...
### 3.11.2 Dimensionality Reduction: UMAP
...
### 3.11.4 Automatic Cluster Naming: Claude API
...
## 3.12 Selection of Sources of Evidence
...
:::{figure} figures/fig3_3_prisma_first.png
...
:::{figure} figures/fig3_4_prisma_second.png
...
## 3.13 Characteristics of Sources of Evidence
...
:::{figure} figures/fig3_5a_stacked_bars.png
...
:::{figure} figures/fig3_5b_line_plot.png
...
## 3.14 Results of Individual Sources of Evidence

The full list of included articles (n = 11,000), along with their associated metadata (title, journal, publication year, DOI, and sharing category), is provided in Supplementary Material (`Supplementary_File_S1.xlsx`).

## 3.15 Synthesis of Results
...
:::{figure} figures/fig3_6_umap.png
:label: fig-umap
:align: center
:width: 85%
